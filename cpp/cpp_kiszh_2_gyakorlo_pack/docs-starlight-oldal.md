---
title: C++ KisZH gyakorlócsomag
description: 5 új, automatikusan ellenőrizhető C++ gyakorlófeladatsor a minta KisZH szerkezetében.
---

> Ehhez az oldalhoz a zip fájlt tedd a projekt `public/downloads/` mappájába, például:
> `public/downloads/cpp-kiszh-gyakorlo-5-feladat.zip`
>
> Ezután a letöltési link működni fog.

## Letöltés

- [Teljes gyakorlócsomag letöltése](/downloads/cpp-kiszh-gyakorlo-5-feladat.zip)
